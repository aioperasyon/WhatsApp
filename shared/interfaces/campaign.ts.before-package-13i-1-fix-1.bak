...
export interface CampaignAudienceAnalysis {
  totalCrm: number;
  filtered: number;
  allowed: number;
  validPhone: number;
  sendable: number;
  excludedByPermission: number;
