...
echo AI Operasyon - Campaign Queue Final Cleanup Paket 13G-43
echo.
...
echo.
echo Paket 13G-43 basariyla kuruldu.
echo.
...
echo copy /y "src\main\services\campaign-queue.service.ts.before-package-13g-43.bak" "src\main\services\campaign-queue.service.ts"
echo.
pause
exit /b 1
