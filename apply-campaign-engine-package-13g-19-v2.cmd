...
echo AI Operasyon - Campaign State Repository Paket 13G-19 V2
echo.
...
echo.
echo Paket 13G-19 V2 basariyla kuruldu.
pause
exit /b 0
...
echo copy /y "src\main\services\campaign-queue.service.ts.before-package-13g-19-v2.bak" "src\main\services\campaign-queue.service.ts"
