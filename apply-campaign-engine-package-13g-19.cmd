...
echo AI Operasyon - Campaign State Repository Paket 13G-19
echo.
...
if not exist ".package-13g-19.cjs" (
  echo Paket uygulama dosyasi bulunamadi.
  pause
  exit /b 1
)

node ".package-13g-19.cjs"
...
echo.
echo Paket 13G-19 basariyla kuruldu.
echo.
echo Tasindilar:
...
echo copy /y "src\main\services\campaign-queue.service.ts.before-package-13g-19.bak" "src\main\services\campaign-queue.service.ts"
